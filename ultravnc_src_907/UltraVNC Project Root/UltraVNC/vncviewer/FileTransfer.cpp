/////////////////////////////////////////////////////////////////////////////
//  Copyright (C) 2002-2007 Sihl Remoto Team Members. All Rights Reserved.
//
...
//	vnclog.Print(0, _T("ReceiveFileChunk\n"));
	...
	// We still support the *dirty* old "Abort" method (for backward compatibility wirh Sihl Remoto Servers <=RC18)
	if (UsingOldProtocol())
	{
	...
	case WM_INITDIALOG:
		{
			...
			_snprintf(szTitle, lTitleBufSize-1," %s < %s>  -  Sihl Remoto", sz_H35,szRemoteName);
