...
void WarningException::Report()
{
	...
	//MessageBox(NULL, m_info, " Sihl Remoto Info", MB_OK| MB_ICONEXCLAMATION | MB_SETFOREGROUND | MB_TOPMOST);
}
...
#endif
	ShowMessageBox2(m_info,m_error_nr);
	//MessageBox(NULL, m_info, " Sihl Remoto Info", MB_OK | MB_ICONSTOP | MB_SETFOREGROUND | MB_TOPMOST);
}
