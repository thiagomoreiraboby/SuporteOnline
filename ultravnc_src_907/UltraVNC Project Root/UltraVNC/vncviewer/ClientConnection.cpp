/////////////////////////////////////////////////////////////////////////////
//  Copyright (C) 2002-2013 Sihl Remoto Team Members. All Rights Reserved.
//
...
const UINT FileTransferSendPacketMessage = RegisterWindowMessage("Sihl Remoto.Viewer.FileTransferSendPacketMessage");
extern bool g_passwordfailed;
bool havetobekilled=false;
bool forcedexit=false;
const UINT RebuildToolbarMessage = RegisterWindowMessage("Sihl Remoto.Viewer.RebuildToolbar");
...
void ClientConnection::NegotiateProtocolVersion()
{
	...
	*/
	...
	// Sihl Remoto specific functionnalities
	// - ms logon
	...
	{
		// adzm2010-10 - RFB3.8 - m_fServerKnowsFileTransfer set during rfbSihl Remoto auth
	}
...
void ClientConnection::ReadServerInit()
{
	...
	if (m_pDSMPlugin->IsEnabled() && m_fUsePlugin)
	{
			char szMess[255];
			memset(szMess, 0, 255);
			sprintf(szMess, "--- Sihl Remoto Viewer + %s-v%s by %s ",
...
//				break;
	...
	//						DestroyWindow(_this->m_hwndTBwin);
						...
						else // Autoreconnect allowed - We only suspend the working thread then reconnect a few seconds later
						{
							...
							strcpy(wtext,"Sihl Remoto Viewer - Connection dropped, trying to reconnect (");
							strcat(wtext,temp);
							strcat(wtext,")");
